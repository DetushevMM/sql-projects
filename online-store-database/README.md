...
### seed.sql
Наполняет таблицы тестовыми данными: 5 клиентов, 4 категории, 9 товаров, 5 заказов, 9 позиций заказов, 4 статуса.
...
3. Суммарные продажи по клиентам
4. Суммарные продажи по категориям
...
ER-диаграмма для визуального представленияедставления
